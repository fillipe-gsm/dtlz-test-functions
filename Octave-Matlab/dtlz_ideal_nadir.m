...
%   
%   Input arguments:
%      fname: a string with the name of the desired DTLZ function
%      M: an integer with the number of objectives
%      
%   Output argument:
%      pareto_ranges: a (M x 2) matrix wherein the first and second columns have
%                     the ideal and Nadir solutions, respectively
